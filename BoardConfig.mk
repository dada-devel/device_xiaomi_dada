...
# Board (override common - device reports as dada to fastboot)
...
PRODUCT_COPY_FILES += \
    ...
    $(call find-copy-subdir-files,*,$(KERNEL_PATH)/system_dlkm/,$(TARGET_COPY_OUT_SYSTEM_DLKM)/lib/modules/6.6.77-android15-8-gf9a1d4bd8353-abogki440974771-4k)

# OTA assert
TARGET_OTA_ASSERT_DEVICE := dada
